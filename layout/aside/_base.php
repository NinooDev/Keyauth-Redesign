...
?>
				...
				<div id="kt_aside" class="aside aside-dark aside-dark aside-hoverable" data-kt-aside-minimize="on" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<?php
					if(isset($_POST["aside-minimize"]))
					{
						$value = $_POST["aside-minimize"];
						success($value);
					}							
